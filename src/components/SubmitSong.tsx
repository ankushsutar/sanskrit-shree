        ...
        <section id="submit" className="py-24 px-6 relative overflow-hidden bg-temple">
            ...
            <div className="max-w-4xl mx-auto relative z-10 manuscript p-8 md:p-16 rounded-sm border-gold/20">
                <div className="text-center mb-12">
                    ...
                    <h2 className="font-cairo text-4xl md:text-5xl font-black text-white mb-4 uppercase tracking-widest">
                        Suggest a Song
                    </h2>
                    <p className="font-cairo text-xl text-white/50 border-t border-gold/10 pt-4 mt-4">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-10" onSubmit={(e) => e.preventDefault()}>
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <label className="font-cairo text-gold text-[10px] tracking-[0.3em] font-black uppercase">Song Name</label>
                            <span className="font-noto text-[10px] text-saffron/40 italic">गीतनाम</span>
                        </div>
                        <input
                            type="text"
                            placeholder="e.g. Bohemian Rhapsody"
                            className="w-full bg-gold/5 border-b border-gold/20 px-0 py-4 text-white focus:outline-none focus:border-gold transition-all font-cairo text-lg placeholder:text-white/10"
                        />
                    </div>
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <label className="font-cairo text-gold text-[10px] tracking-[0.3em] font-black uppercase">Original Language</label>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <label className="font-cairo text-gold text-[10px] tracking-[0.3em] font-black uppercase">Artist Name</label>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <label className="font-cairo text-gold text-[10px] tracking-[0.3em] font-black uppercase">Your Email</label>
                    ...
                    <div className="md:col-span-2 pt-6">
                        <button className="w-full bg-saffron text-temple font-cairo font-black py-6 rounded-sm text-xl tracking-[0.4em] uppercase hover:bg-white transition-all shadow-2xl shadow-saffron/20 group">
